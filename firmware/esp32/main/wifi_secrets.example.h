...
#define MESSAGE_BOX_WIFI_SSID "YOUR_WIFI_NAME"
#define MESSAGE_BOX_WIFI_PASSWORD "YOUR_WIFI_PASSWORD"
#define MESSAGE_BOX_API_URL "http://YOUR_MAC_IP:3000/api/recordings"
